        ...
        try {
            ...
            if (resource.tempDiskId) {
                ...
                if (overwrite && destinationResource) {
                    ...
                    await fs_extra_1.default.copy(path_1.default.join(this.server.tempDiskPath, resource.tempDiskId), path_1.default.join(this.server.tempDiskPath, destinationTempDiskFileId));
